...
class Traceroute:
    ...
    def print_start(self):
        print(f'traceroute to {self.destination_server} ({self.destination_ip}), {self.max_hops} hops max, {self.packet_size} byte packets')

    def print_unknownhost(self):
        print(f'traceroute: unknown host {self.destination_server}')
